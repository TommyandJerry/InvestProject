...
public class DateUtil {
     ...
     */
    public String getStringAllDate() {
    ...
    public String dateToStr(java.time.LocalDate dateDate) {
     ...
     * @return
     */
    public Timestamp strToDateSql(String strDate) {
        ParsePosition pos = new ParsePosition(0);
     ...
     * @date 2016-4-20
     */
    public String getHHMMSS(String value){
        String hour="00";
        String minute="00";
        String second="00";
     ...
     */
    public String getFromNow(int day) {
        Date date = new Date();
     ...
     * @return
     */
    public String getNowMonth(String sdate) {
        // 取该时间所在月的一号
     ...
     * @param
     */
    public boolean RightDate(String date) {
    ...
    public String getNextMonthDay(String sdate, int m) {
        sdate = getOKDate(sdate);
     ...
     */
    public String getOKDate(String sdate) {
        if (sdate == null || sdate.equals(""))
...
//    sdate = VeStr.Replace(sdate, "/", "-");
     ...
     * @return
     */
    private String getBeforeDay(Calendar cl){
        //使用roll方法进行向前回滚
     ...
     * @return
     */
    private String getAfterDay(Calendar cl){
        //使用roll方法进行回滚到后一天的时间
        //cl.roll(Calendar.DATE, 1);
        //使用set方法直接设置时间值
        //int day = cl.get(Calendar.DATE);
    ...
    private int compareToDateString(String date1,String date2){
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        int i=0;
        try {
